...
// Derived from Yata v0.7.0, src/core/candles.rs.
...
/// println!("{:?}", converted);
/// ```
#[derive(Debug, Clone, Copy, Default, PartialOrd, Serialize, Deserialize)]
pub struct Candle {
