...
// Derived from Yata v0.7.0, src/methods/highest_lowest.rs.
...
/// ```
/// use roze_ta::prelude::*;
/// use roze_ta::methods::HighestLowestDelta;
///
///
...
///
/// ```
/// use roze_ta::core::Method;
/// use roze_ta::methods::Highest;
///
/// let values = [1.0, 2.0, 3.0, 2.0, 1.0, 0.5, 2.0, 3.0];
