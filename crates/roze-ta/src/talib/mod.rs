...
//!
//! ```
//! use roze_ta::talib::{Core, RetCode};
//!
...
//!
//! This maintained module forbids unsafe code. Batch functions use the portable
...
#![allow(clippy::approx_constant)] // PI (180/3.141592653589793) is copied verbatim from the C source.
                                   ...
                                   // directory's name, and `roze_ta::talib::ta_func::Core` would stutter; the glob below is
