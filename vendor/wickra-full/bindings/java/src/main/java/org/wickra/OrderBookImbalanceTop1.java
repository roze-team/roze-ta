...
public final class OrderBookImbalanceTop1 implements AutoCloseable {
    ...
    public double[] batch(double[] bidPrice, double[] bidSize, int nBids, double[] askPrice, double[] askSize, int nAsks) {
        ...
        try (Arena a = Arena.ofConfined()) {
            ...
            NativeMethods.WICKRA_ORDER_BOOK_IMBALANCE_TOP1_BATCH.invokeExact(handle(), bidPriceSeg, bidSizeSeg, (long) nBids, askPriceSeg, askSizeSeg, (long) nAsks, outSeg, (long) n);
